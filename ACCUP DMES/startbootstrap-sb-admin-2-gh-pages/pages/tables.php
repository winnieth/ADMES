...
<body>
  ...
  <button type="button" class="btn btn-info" onclick="window.location.href='register.php'">CREATE</button>
  <button type="button" class="btn btn-info" onclick="window.location.href=''">DELETE</button>
                         ...
                         <div class="panel-body">
                            <div class="list-group">
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-comment fa-fw"></i> New Uploaded files
                                    <span class="pull-right text-muted small"><em>4 minutes ago</em>
                                    </span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-twitter fa-fw"></i> New Requested files
                                ...
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-money fa-fw"></i> Document Received
