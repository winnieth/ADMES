...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            $sql="SELECT * FROM users INNER JOIN areas ON users.area_id = areas.area_id
             WHERE user_id=".$id;
            ...
            ?>
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        ...
                        <a href="pr_addac.php"><i class="fa fa-arrow-left"></i></a>
                        </span>
                        <h3 class="panel-title text-center">Update User Info</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form" action="update_ac.php"  method="post">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <select name="area" class="form-control" >
                                        <option class="list-group-item disabled"placeholder="" value="<?php echo $ar?>"><?php echo $arn?></option>
                                        <?php  //displaying area 
                                                include "connectdb.php";
