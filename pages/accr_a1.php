...
<body>
    ...
    <div id="wrapper" style=" background-color: #eee">
        ...
        <!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; background-color: #eee">
        ...
        <div id="page-wrapper" style="margin-left:100px; margin-right:100px; background-color: #fbfffa">
            <div class="row" style>
                <div class="col-lg-12">
                    <?php
...
//echo "</th></tr>";
    ...
    */
    ...
    for($c=1; $c <=$rows7; $c++){
        ...
        echo"<tr>";
        echo "<td  class='text-left'><b>&emsp;".$clss['class']."</td></b>";
        ...
        echo "<td></td><td></td><td>Siom: ".$rows8['siom']."</td></tr>";
        $total +=$rows8['siom'];
        $counter++;
            ...
            for($b=0; $b<$rows2; $b++){
                ...
                if ($bnch['has_sub']==1){
                    ...
                    $sql5="SELECT ROUND( AVG(rating),2 ) as 'ave' FROM `sub_benchmark` WHERE bnch_id = " . $bnch['bnch_id'];
                        ...
                        //echo "Ave: " . $rows5['ave'];
                    echo"<tr>";
                    echo "<td class='text-left'><a>&emsp;&emsp;".$bnch['bnch_desc']."</a></td>"; // print ang benchmark na naay sub
                    echo "<td></td><td>".$rows5['ave']."</td><td></td>";
                    echo"</tr>";
                    //echo "&emsp; <br>";
                   // echo"IR rating: ".$rows5['ave']."<br>";
                    ...
                    if ($rows3){
                        ...
                        for ($s=0; $s < $rows3; $s++){
                            ...
                            echo"<tr>";
                            echo "<td  class='text-left'><a href='accr_img.php?param_id=".$prm['param_id']."&bench_id=".$bnch['bnch_id']." '>&emsp;&emsp;&emsp;&emsp;".$sub['sbench_desc']."</a>";
                            echo "</td>";
                            ...
                            $rows6=$result6 -> fetch_assoc();
                                ...
                                if($rows6['rating']==0){
                                    ...
                                    <form action='up_sub_rate.php' method='POST'>
                    ...
                    //echo "<tr><td>";
                    echo "<tr><td  class='text-left'><a href='accr_img.php?param_id=".$prm_id."&bench_id=".$bnch['bnch_id']."''>&emsp;&emsp;".$bnch['bnch_desc']."</a></td>";
                    echo"<td>".$bnch['rating_scale']."</td><td>";
                    
                    //echo "</td>";
                    //echo "<td>";
                    if($bnch['rating_scale']==""){ //wla pay rating
                        echo"
                    
                    
                    <form action='accr_r.php' method='POST'>
