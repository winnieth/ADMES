        ...
        <div id="page-wrapper">
            <!--Search bar-->
                ...
                <h4><?php 
                            ...
                            //echo $_SESSION['area']; 
                            $q="SELECT * FROM areas WHERE area_id=".$area;
                            $r=mysqli_query($db,$q);
                            $f= $r -> fetch_array();
            ...
            //echo $_SESSION['area'];
                ...
                $sql2="SELECT * FROM parameters WHERE area_id='$area'";
                            ...
                            for($b=0; $b<$rows2; $b++){
                                ...
                                if ($bnch['has_sub']==1){
                                    ...
                                    for ($s=0; $s < $rows3; $s++){
                                        ...
                                        <a href='pc_img.php?param_id=".$prm_id."&bench_id=".$bnch['bnch_id']."&sbench_id=".$sub['sbench_id']."&is_sub=1' >
                                ...
                                <a href='pc_img.php?param_id=".$prm_id."&bench_id=".$bnch['bnch_id']."' '>".$bnch['bnch_desc']."</a><br>";
                                //echo "hahai".$prm_id;
                                //echo "<form action='pc_img.php' method='GET'><input type='hidden' name='p' value="$prm['param_id']">
