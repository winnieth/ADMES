        ...
        $GLOBALS['img']= array();
          ...
          if (!$conn){
            ...
            if ($GLOBALS['rows']){
                ...
                echo "<a data-toggle='modal' data-target='#myModal'style='text-decoration: none,'>
                <img class=' img-responsive img-fluid img-thumbnail' src=".$image['file_path'].=$image['file_name']." width='204px' height='136px'>
                </a>&ensp;
                ";
                }
            }
